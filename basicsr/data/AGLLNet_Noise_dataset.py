...
class AGLLNet_Noise_Dataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(AGLLNet_Noise_Dataset, self).__init__()
        self.opt = opt
        ...
        if self.opt['phase'] == 'train':
            self.imgs_ll = glob.glob(os.path.join(opt['dataroot'], 'train_lowlight', '*.*'))
            ...
            self.imgs_ll = glob.glob(os.path.join(opt['dataroot'], 'test_lowlight', 'input', '*.*'))
